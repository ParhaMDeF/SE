...
در توسعه نرم افزار ، تمرین چیزی نیست جز یک راه کلی از شیوه کدنویسی یا چگونگی نوشتن کدی که قرار نیست در قسمت های دیگر Solution ما تکرار شود ، یا استفاده از ظرفیت های برنامه نویسی شی گرا . در اینجا ایده های بسیاری وجود دارد که تمرین خوبی در طراحی محسوب میشوند.
