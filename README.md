...
معماری نرم افزار یکی از مهم ترین گام ها پیش از شروع به پیاده سازی هر گونه سیستم و نرم افزار است که باید روی آن توجه اکید داشت تا کیفیت کلی و قابلیت اطمینان سیستم به بالاترین حد خود برسد و میزان هزینه ها تا حد ممکن کاهش یابد. همجنین باعث دیباگ کردن آسان سیستم و اضافه کردن قابلیت های جدید بدون دخالت در ساختار قسمت های دیگر می شود. 
